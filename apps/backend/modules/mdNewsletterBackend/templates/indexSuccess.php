...
<?php slot('newsletter', ':D') ?>
<?php slot('nav') ?>Newsletter<?php end_slot(); ?>
        ...
        <div class="md_center">
            ...
            <div class="md_content_center">
                ...
                <?php if(!isset($hasAdd) || (isset($hasAdd) && $hasAdd)): ?>
                    ...
                    -->
                    <a href='<?php echo url_for('mdNewsletterBackend/createNew');?>'>Agregar</a>
                <?php endif; ?>
                </div>              
  ...
  <div class="md_right_shadow">
      <div class="md_center_right">
          <div class="md_content_right">
              <h1>Agregar Usuario (<?php echo mdNewsletterHandler::retrieveNumberOfUserInNewsLetter();?>)</h1>
              <?php
                $itIsFiltered = false;
                if(isset($isFiltered))
                {
